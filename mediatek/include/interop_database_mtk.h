...
// Added for A2DP, @start {
    ...
    {{{0x00, 0x00, 0x46, 0, 0, 0}}, 3, INTEROP_MTK_ADVANCED_A2DP_CONNECT},
     ...
     //some device no voice when dut exit voice assistant
     // {0x80, 0x57, 0x19}, /HM1900/
     {{{0x80, 0x57, 0x19, 0, 0, 0}}, 3, INTEROP_MTK_A2DP_SET_STANDBY_TIME},
...
// Added for GAP, @start {
  ...
  {{{0x00, 0x0e, 0x9f, 0, 0, 0}}, 3, INTEROP_MTK_DISABLE_AUTO_PAIRING},
    ...
    {{{0x10, 0x4b, 0x46, 0, 0, 0}}, 3, INTEROP_MTK_GET_UUIDS_FROM_STORAGE},
...
// } @end
    ...
    {{{0x00, 0x00, 0x05, 0, 0, 0}}, 3, INTEROP_MTK_SDP_PBAP_1_1},
    {{{0xd4, 0xca, 0x6e, 0, 0, 0}}, 3, INTEROP_MTK_SDP_PBAP_1_1},
    {{{0x22, 0x22, 0x1c, 0, 0, 0}}, 3, INTEROP_MTK_SDP_PBAP_1_1},
...
// Added for PBAP, @start {
    {"Discovery Sport", 15, INTEROP_MTK_SDP_PBAP_1_1},
//} @end
